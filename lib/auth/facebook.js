...
var credentials = {
	clientID: "1245481955543966",
	clientSecret: "9b5b6b57de793ae9bdd8b4559b33ea7a",
	callbackURL: "http://jangkoo.com/auth/facebook"
};
...
exports.authenticateUser = function(req, res, next) {
	...
	if (!_.has(req.query, 'cb')) {
		...
		passport.authenticate('facebook', { session: true }, function(err, data, info) {
			...
			console.log("facebook.js", req.session.auth);
